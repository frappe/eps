...
from eps.eps.doctype.energy_point_log.energy_point_log import create_review_points_log
...
class EnergyPointSettings(Document):
	...
	if TYPE_CHECKING:
		...
		from eps.eps.doctype.review_level.review_level import ReviewLevel
